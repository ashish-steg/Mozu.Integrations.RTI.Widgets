...
function($, HyprLiveContext, _, api,Backbone, ProductModels, CartModels, CartMonitort) {
    ...
    var ProductListView = Backbone.MozuView.extend({
        templateName: 'Widgets/catalog/rti-product-tiles',
        additionalEvents: {
            "click .next": "next",
    ...
    var renderSlider = function(data) {
        ...
        var products = data.widgetResults[0].slotResults;
        var productIdList = [];
